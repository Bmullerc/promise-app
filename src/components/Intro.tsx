export function Intro() {
  return (
    <article id="intro" className="my-20 border-b-2 border-purple-400">
      ...
      <div className="flex flex-col gap-4">
        <h2 id="xml" className="text-3xl font-bold mt-12">XML</h2>
      ...
      <div className="flex flex-col gap-4">
        <h2 id="json" className="text-3xl font-bold mt-12">JSON</h2>
