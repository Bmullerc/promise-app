...
export function Axios() {
  return (
    <article id="axios" className="my-20 border-b-4 border-purple-200 flex flex-col gap-4 pb-10">
      ...
      <h3 className="text-2xl font-bold mb-4 mt-6">Is this another mythological god?</h3>
      <p>Hehe, funny. Axios is a popular promise-based HTTP client that enables JavaScript developers to easily send HTTP requests to back-end APIs and also handle its response.</p>
