...
export const RESTful = () => {
  return (
    <article id="restful" className="my-20 border-b-4 border-purple-200 pb-20 flex flex-col gap-4">
      ...
      <p>No... <Emp>RESTful (Representational State Transfer)</Emp> is an architectural style based on the principles of the <Emp>REST</Emp> used for building distributed systems.</p>
