export function About() {
  return (
    <aside id="about" className="h-fit py-12 mt-12 px-4 lg:px-20 xl:px-32 2xl:px-72 bg-lime-300 text-purple-900">
      ...
      <p>The main focus of this project is to study <a href="#async-header" className="hover:text-purple-400 font-bold">Asynchronous Javascript Methods</a> and <a href="#fetch-header" className="hover:text-purple-400 font-bold">API Fetching</a>.</p>
    </aside>
  )
}